                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($data->status == 'Diterima') { ?>
                                                                <a href="<?= base_url('cetak-surat-keterangan-pengantar/' . $data->id . '?nomor=' . $data->nomor_surat) ?>" class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-printer-fill"></i> Cetak</a>
