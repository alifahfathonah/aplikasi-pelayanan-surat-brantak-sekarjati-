                                                        ...
                                                        <td>
                                                            <?php if ($this->session->userdata('role_id') == 1) { ?>
                                                                <?php if ($data->status == 'Menunggu Verifikasi') { ?>
                                                                    <div class="btn-group">
                                                                        <form action="<?= base_url('update-status-skk') ?>" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <form action="<?= base_url('komentar-skk/') . $data->id ?>" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a href="<?= base_url('hapus-surat-kematian/' . $data->id) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php } else if ($this->session->userdata('role_id') == 2) { ?>
                                                                ...
                                                                <?php } else if ($data->status == 'Terverifikasi') { ?>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <form action="<?= base_url('update-status-skk') ?>" method="post" enctype="multipart/form-data" readonly>
                                                                            <input type="hidden" name="id" value="<?= $data->id ?>" class="form-control" readonly>
                                                                            <input type="hidden" name="id_warga" value="<?= $data->id_warga ?>" class="form-control" readonly>
                                                                            <input type="hidden" name="status" value="Ditolak" class="form-control" readonly>
