            								...
            								<tbody>
												...
												foreach ($datas as $data) { ?>
            										<tr>
            											...
            											<td>
            												<a href="<?= base_url('preview-sku/' . $data->id) ?>"><span class="badge bg-info">Preview Data</span></a>
            											</td>
            											<td>
            												<?php if ($this->session->userdata('role_id') == 1) { ?>
            													...
            													<?php } else if ($data->status == 'Diterima') { ?>
            														<div class="btn-group">
            															<a href="<?= base_url('cetak-surat-usaha/' . $data->id . '?nomor=' . $data->nomor_surat) ?>" class="btn btn-primary btn-sm" target="blank_"><i class="bi bi-printer-fill"></i></a>
            														...
            														<div class="modal-dialog">
            															<div class="modal-content">
            																...
            																<div class="modal-footer">
            																	...
            																	<a href="<?= base_url('hapus-surat-usaha/' . $data->id) ?>" class="btn btn-danger btn-sm">Hapus</a>
            																</div>
            															</div>
            														</div>
            													</div>
            												...
            												<?php } else if ($this->session->userdata('role_id') == 2) { ?>
            													...
            													<?php } else if ($data->status == 'Terverifikasi') { ?>
            														<div class="btn-group">
            															...
            															<form action="<?= base_url('update-status-sku') ?>" method="post" enctype="multipart/form-data" readonly>
            																<input type="hidden" name="id" value="<?= $data->id ?>" class="form-control" readonly>
            																<input type="hidden" name="id_warga" value="<?= $data->id_warga ?>" class="form-control" readonly>
            																<input type="hidden" name="status" value="Ditolak" class="form-control" readonly>
