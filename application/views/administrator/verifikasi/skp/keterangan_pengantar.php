            								...
            								<tbody>
												...
												foreach ($datas as $data) { ?>
            										<tr>
            											...
            											<td>
            												<a href="<?= base_url('preview-skp/' . $data->id) ?>"><span class="badge bg-info">Preview Data</span></a>
            											</td>
            											<td>
            															...
            															<div class="modal-dialog">
            																<div class="modal-content">
            																	...
            																	<div class="modal-body">
            																		<div class="row">
            																			<div class="col-lg-12">
            																				<form action="<?= base_url('komentar-skp/') . $data->id ?>" method="post" enctype="multipart/form-data">
            												...
            												<?php } else if ($this->session->userdata('role_id') == 2) { ?>
																...
																if ($data->status == 'Terverifikasi') { ?>
            														<div class="btn-group">
            															...
            															<form action="<?= base_url('update-status-skp') ?>" method="post" enctype="multipart/form-data" readonly>
            																<input type="hidden" name="id" value="<?= $data->id ?>" class="form-control" readonly>
            																<input type="hidden" name="id_warga" value="<?= $data->id_warga ?>" class="form-control" readonly>
            																<input type="hidden" name="status" value="Ditolak" class="form-control" readonly>
